...
WebTrends.prototype.dcsVar=function(){
	...
	if(this.qry["referer"]){
		DCS.dcsref=dcsTrim(this.qry["referer"].replace("https","http"));
	}
...
WebTrends.prototype.dcsisS = function()
{
    ...
    if(dcsExec(u,".baidu.com|.google.|.360.cn|.so.com|.haosou.com|.sm.cn|.yahoo.|.soso.com|.114search.|.aol.com|.bing.com|.sogou.com|.live.com")&&dcsExec(u,"[?&]keyword=|[?&]key_word=|[?&]word=|[?&]wd=|[?&]q=|[?&]p=|[?&]w=|[?&]query=")) return true;
    else return false;
};
							...
							for(var i=0;i<objs.length;i++)
								{
									item = objs[i].split("=")[0];
									val = objs[i].split("=")[1];
									if(typeof(val)!="undefined"&&val.length>maxlen) 
										{
											maxlen = val.length;
											if(f.indexOf("?"+item)!=-1)
